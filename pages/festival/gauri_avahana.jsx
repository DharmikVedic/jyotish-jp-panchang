...
export default function GauriAvahana() {
            ...
            {loader||input=="" ? (
                ...
                <div className="bg-zinc-100 min-h-screen pt-10 pb-28 px-5">
                    <div className="max-w-[750px]  mx-auto flex flex-col gap-20">
                        <FestivalDetailCard
                            festival_name="Gauri Avahana"
                            date={tithi?.festival_date}
                        />
                        <MuhuratDetail nakshatra="Anuradha Nakshatra" muhurattext="Avahana Muhurat" muhurtastart={tithi?.muhurta_start_time} muhurtend={tithi?.muhurta_end_time} festival_date={tithi?.festival_date} nakshatra_start={tithi?.nakshatra_start_time}  nakshatra_end={tithi?.nakshatra_end_time} name="Gauri Avahana"/>
