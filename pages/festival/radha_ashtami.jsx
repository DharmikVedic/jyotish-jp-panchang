...
export default function RadhaAshtami() {
            ...
            {loader||input=="" ? (
                ...
                <div className="bg-zinc-100 min-h-screen pt-10 pb-28 px-5">
                    <div className="max-w-[750px]  mx-auto flex flex-col gap-20">
                        <FestivalDetailCard
                            festival_name="Radha Ashtami"
                            date={input.festival_date}
                        />
                        <MuhuratDetail muhurattext="Madhyahna Time " muhurtastart={tithi?.muhurta_start_time} tithiname="Ashtami" muhurtend={tithi?.muhurta_end_time} festival_date={tithi?.festival_date} tithiend={tithi?.tithi_start}  tithistart={tithi?.tithi_end} name="Radha Ashtami "/>
                    </div>
                </div>
            )}
        </>
