            ...
            {loader ?
                ...
                <div className="bg-zinc-100 min-h-screen pt-10 pb-28 px-5">
                    <div className="max-w-[750px]  mx-auto flex flex-col gap-20">
                        <FestivalDetailCard festival_name="Narasima Jayanti"  date={data.festival_date}/>
                        <MuhuratArrayDetail muhurattext={["Narasimha Jayanti Sayana Kala Puja Time","Next Day Parana Time for Narasimha Jayanti"]} hightlight="Muhurat" muhurta={data.muhurta} festival_date={data.festival_date}  tithi={data.tithi} name="Narasima Jayanti"/>
                    </div>
                </div>
            }
        </>
