            ...
            {loader ?
                ...
                <div className="bg-zinc-100 min-h-screen pt-10 pb-28 px-5">
                    <div className="max-w-[750px]  mx-auto flex flex-col gap-20">
                        <FestivalDetailCard festival_name="Meena Sankranti "  date={"2022-11-19"}/>
                        <SankrantiDetail festival_date="2022-11-19" moment={data.sankranti_moment}  punya={data.punya_kal} mahapunya={data.maha_punya_kal} name="Meena Sankranti "/>
                    </div>
                </div>
            }
        </>
