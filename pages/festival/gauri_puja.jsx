...
export default function GauriPuja() {
            ...
            {loader||input=="" ? (
                ...
                <div className="bg-zinc-100 min-h-screen pt-10 pb-28 px-5">
                    <div className="max-w-[750px]  mx-auto flex flex-col gap-20">
                        <FestivalDetailCard
                            festival_name="Gauri Puja"
                            date={tithi?.festival_date}
                        />
                        <MuhuratDetail muhurtastart={tithi?.muhurta_start_time} nakshatra={tithi?.nakshatra} muhurtend={tithi?.muhurta_end_time} festival_date={tithi?.festival_date}  name="Gauri Puja"/>
                    </div>
                </div>
            )}
        </>
