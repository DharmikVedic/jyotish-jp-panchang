            ...
            {loader ?
                ...
                <div className="bg-zinc-100 min-h-screen pt-10 pb-28 px-5">
                    <div className="max-w-[750px]  mx-auto flex flex-col gap-20">
                        <FestivalDetailCard festival_name="Ugadi"  date={data.festival_date}/>
                        <MuhutatDate festival_date={data.festival_date}  tithi={data.tithi} name="Ugadi "/>
                    </div>
                </div>
            }
        </>
