...
export  default function KumbhaSankranti(){
            ...
            {loader || data == ""?
                ...
                <div className="bg-zinc-100 min-h-screen pt-10 pb-28 px-5">
                    <div className="max-w-[750px]  mx-auto flex flex-col gap-20">
                        <FestivalDetailCard festival_name="Kumbha Sankranti "  date={input?.festival_date}/>
                        <SankrantiDetail festival_date={input?.festival_date} moment={data?.sankranti_moment}  punya={data?.punya_kal} mahapunya={data?.maha_punya_kal} name="Kumbha Sankranti "/>
                    </div>
                </div>
            }
        </>
