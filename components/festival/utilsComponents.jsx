...
export function SankrantiDetail({
  name,
  punya,
  mahapunya,
  festival_date,
    ...
    <>
      <div className="relative border-2  border-sky-500 bg-white flex flex-col gap-8 pt-10 pb-5 px-5 md:p-10">
        ...
        <div className="flex bg-zinc-50 border-2 md:text-lg flex-col gap-2 bg-white p-5 text-center rounded">
          ...
          <div>
            <p className="text-yellow-600 font-semibold">
              {name} Maha Punya Kala - {mahapunya.start_time} to{" "}
              {mahapunya.end_time}
            </p>
            <p className="text-base text-zinc-500">
              Duration - 08 Hours 42 Mins
    ...
    <>
      <div className="relative border-2  border-sky-500 bg-white flex flex-col gap-8 pt-10 pb-5 px-5 md:p-10">
        ...
        <div className="flex bg-zinc-50 border-2 md:text-lg flex-col gap-2 bg-white p-5 text-center rounded">
          <div>
            <p className="text-yellow-600 font-semibold">
              {name} {muhurattext ? muhurattext : "Puja Muhurat"} -{" "}
              {muhurta.muhurta_start_time} to {muhurta.muhurta_end_time}
            </p>
            <p className="text-base text-zinc-500">
              Duration - 08 Hours 42 Mins
            </p>
        ...
        <p className="md:text-lg">
          {tithiid[tithi["tithi_id"]]} Begins -{" "}
          <span className="text-yellow-600">{tithi.tithi_start_time}</span>
          <br />
          {tithiid[tithi["tithi_id"]]} Ends -{" "}
          <span className="text-yellow-600">{tithi.tithi_end_time}</span>
        </p>
      </div>
    </>
  );
...
export function MuhuratArrayDetail({
  hightlight,
  name,
  muhurta,
  festival_date,
    ...
    <>
      <div className="relative border-2  border-sky-500 bg-white flex flex-col gap-8 pt-10 pb-5 px-5 md:p-10">
        ...
        {muhurta.map((item, i) => (
          <div
            key={i}
            className="flex bg-zinc-50 border-2 md:text-lg flex-col gap-2 bg-white p-5 text-center rounded"
          >
            <div>
              <p className="text-yellow-600 font-semibold">
                {muhurattext[i]} - {item.muhurta_start_time} to{" "}
                {item.muhurta_end_time}
              </p>
              <p className="text-base text-zinc-500">
                Duration - 08 Hours 42 Mins
              </p>
